<div class="app-field-parent" v-bind="$attrs">
  <div class="md-form-group app-field-input-container" :field-name="name">
    <div class="app-field-image-container" :style="{'background-color': (current_image != null ? dropColor : null) || 'white', 'border-bottom': state === 'error' ? 'solid 1px #cdcdcd !important' : null}">
